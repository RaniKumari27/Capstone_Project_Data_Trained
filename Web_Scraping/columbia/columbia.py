...
from columbia_shoe import get_columbia_shoe

# import all the links from columbia-link
df = pd.read_csv('./columbia-link.csv')
...
for link in links:
    print(link)
    data_list_for_link = get_columbia_shoe(link, driver)
